...
static const char *const yytname[] =
{
  ...
  "RPAREN", "LBRACE", "RBRACE", "COMMA", "PLUS", "ID", "STRING", "$accept",
  "prog", "function", "statements", "statement", "funcall", YY_NULLPTR
};
#endif
...
{
       1,     4,     5,     6,     8,     7,    12,    13,    15,    17,
       0,     0,    16,     0,     0,    14
};

static const yytype_int8 yycheck[] =
{
      11,     5,     0,     6,    11,     7,     5,     8,     4,     6,
      -1,    -1,    12,    -1,    -1,    10
};
...
#line 59 "parser.y" /* yacc.c:1646  */
    {
         printf("%s%s", genString(), (yyvsp[0].str));
...
#line 81 "parser.y" /* yacc.c:1646  */
    {
            ...
            int sid = addString((yyvsp[-1].str));
            char *code = (char*) malloc(128);
            sprintf(code,"movl\t$.LC%d, %%edi\n\tcall\t%s",sid,(yyvsp[-3].str));
            (yyval.str) = code;
