...
// - caller then calls this function until it returns NULL, meaning end of
//     all symbols; each return value is a pointer to a symbol in the table
...
//
// Walk the table and lists and free all symbol names
// and symbol structs
// -- caller should probably free their table after this!
//
