...
{
       0,    66,    66,    84,    89,    91,    99,   104,   106,   108,
     111,   121,   131,   134,   140,   142,   149,   156,   161,   166,
     175,   180,   181,   184,   187,   190,   194
};
#endif
...
{
  "$end", "error", "$undefined", "NUMBER", "SEMICOLON", "LPAREN",
  "RPAREN", "LBRACE", "RBRACE", "COMMA", "PLUS", "EQUALS", "ID", "STRING",
  "KWINT", "KWCHAR", "$accept", "prog", "functions", "function",
  "statements", "statement", "funcall", "assignment", "arguments",
  "argument", "expression", "declarations", "vardecl", "parameters", YY_NULLPTR
};
#endif
...
{
      -9,    -5,     4,    14,     5,    15,   -29,   -29,   -29,    13,
     -29,     5,    -9,    -9,   -29,   -29,    12,    16,    -9,    17,
     -29,    11,    -3,    18,    11,   -29,   -29,    -2,     1,   -29,
     -29,   -29,   -29,   -29,    19,    20,    21,    -1,    23,    -2,
       1,   -29,   -29,   -29,    21
};
...
{
      21,     0,     0,     0,     4,     0,    22,    23,     1,     0,
       2,     4,    21,    26,     3,    20,    24,     0,    26,     0,
      25,     7,     0,     0,     7,     8,     9,    14,     0,     5,
       6,    17,    19,    15,     0,    12,    16,     0,     0,    14,
       0,    11,    10,    13,    18
};
...
{
      37,    31,    27,    41,    31,     1,     2,     6,    28,    40,
      32,    33,    44,    32,     8,    16,     7,     9,    13,    12,
      16,    18,    19,    22,    21,    38,    29,    42,    43,    39,
      30,    40,     0,    14,     0,     0,    15,     0,     0,     0,
       0,     0,     0,    20
};

static const yytype_int8 yycheck[] =
{
      28,     3,     5,     4,     3,    14,    15,    12,    11,    10,
      12,    13,    40,    12,     0,    13,    12,    12,     5,     4,
      18,     9,     6,    12,     7,     6,     8,     4,    39,     9,
      24,    10,    -1,    11,    -1,    -1,    12,    -1,    -1,    -1,
      -1,    -1,    -1,    18
};
...
{
       0,    14,    15,    17,    27,    28,    12,    12,     0,    12,
      18,    19,     4,     5,    18,    27,    28,    29,     9,     6,
      29,     7,    12,    20,    21,    22,    23,     5,    11,     8,
      20,     3,    12,    13,    24,    25,    26,    26,     6,     9,
      10,     4,     4,    24,    26
};
...
#line 92 "parser.y" /* yacc.c:1646  */
    { char *code = (char*) malloc(2000);
         sprintf(code,"%s:\n\tpushq %%rbp\n\tmovq %%rsp, %%rbp\n%s\n\tmovl $0, %%eax\n\tpopq %%rbp\n\tret\n\t.size %s, .-%s\n\t", (yyvsp[-6].str), (yyvsp[-1].str), (yyvsp[-6].str), (yyvsp[-6].str));
         funcID[iDIndex][0] = (yyvsp[-6].str);
         iDIndex++;
         (yyval.str) = code;
         }
...
#line 112 "parser.y" /* yacc.c:1646  */
    {
            ...
            sprintf(code,"\t%s\n\tcall\t%s@PLT", (yyvsp[-2].str), (yyvsp[-4].str));
            argNum = 0;
            (yyval.str) = code;
...
#line 150 "parser.y" /* yacc.c:1646  */
    { char *code = (char*) malloc(2000);
          sprintf(code, "%s\n\tmovq\t%%rax, %s", (yyvsp[0].str), argRegStr[argNum]);
          argNum++;
          (yyval.str) = code;
        }
...
#line 176 "parser.y" /* yacc.c:1646  */
    { addSymbol(table, (yyvsp[-2].str), 0, T_INT);
          (yyval.str) = "";
        }
