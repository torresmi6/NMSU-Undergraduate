...
{
   int s;
   if (score1 > score2) // checks for the smalles score and sets it to s
      s = score2;
   else
      s = score1;
   if (s > score3)
      s = score3;
   s = (score1+score2+score3) - s;   // Throws away the smallest score then finds sum
   return s;
}
...
public static void main(String args[])
{
   ...
   try {
      ...
      System.err.println("Error: arguments must be integers!"); // checks for invalid input
      return;
   }
